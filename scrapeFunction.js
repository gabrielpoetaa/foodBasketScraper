import { stopDatabaseConnection } from "./webscraper.js";
...
async function mainScrapingFunction() {
  scrapeCheese()
    ...
    .then(() => {
      ...
      // await stopDatabaseConnection(); // if not already closed
    ...
    .catch(async (error) => {
      ...
      await stopDatabaseConnection().finally(() => {
...
export const scrapingFunction = mainScrapingFunction();
